...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Notepad# in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Notepad# and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
