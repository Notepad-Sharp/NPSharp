...
/**
 * Allows webviews to monitor when an element in the Notepad# editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Notepad# needs to see this
